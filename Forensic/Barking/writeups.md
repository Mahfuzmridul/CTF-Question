...
### 🔎Look closly and you will see that every four byte chunk *"first"* and *"fouth"* byte swaped with each other.
...
## 📑Now swap the bytes to fix it. We can use *"python"* script to swap the bytes.
